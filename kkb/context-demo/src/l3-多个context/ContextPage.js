...
export default class L3ContextPage extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      theme: {
        themeColor: 'l3-normal-color'
      },
      user: {
        name: '小明'
      }
  ...
  render() {
    ...
    return (
      <div>
        <h3>L3ContextPage</h3>
        <L3ThemeContext.Provider value = {theme}>
          <L3UserContext.Provider value = {user}>
            <UseContextPage/>
          </L3UserContext.Provider>
        </L3ThemeContext.Provider>
